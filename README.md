...
- スケジュール: **毎日10投稿 JST**（価値提供8 : 商品紹介2 の比率）
  ...
  - 静的価値投稿 4本: 攻略ネタ2 + 共働きリアル苦悩2（12:00/21:00）
...
| slot | 時刻(JST) | 内容 |
|------|-----------|------|
| 0 | 07:00 | 価値投稿（攻略・保存ネタ） |
| 1 | 08:00 | **商品紹介**（悩み×rank帯ローテ） |
| 2 | 12:00 | **共働きリアル苦悩**（共感投稿） |
| 3 | 15:00 | ランキングダイジェスト |
| 4 | 17:00 | 価値投稿（再利用優先） |
| 5 | 18:00 | ランキングダイジェスト |
| 6 | 19:00 | ランキングダイジェスト |
| 7 | 20:00 | **商品紹介**（悩み×rank帯ローテ） |
| 8 | 21:00 | **共働きリアル苦悩**（共感投稿） |
| 9 | 22:00 | ランキングダイジェスト |
...
- **slot 0 / 4**: セール攻略・レビューの読み方など保存ネタ（36本ローテ）。17:00は再利用キュー優先
- **slot 2 / 8（12:00・21:00）**: **30代共働きのリアル苦悩**（14本ローテ）。攻略ではなく共感・吐露。返信を取りにいく
