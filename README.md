...
日用品 / キッチン / ドリンク（水・ストック飲料）に絞り、「これ、今買う？」の答え合わせをする。美容・ファッション・ガジェット総合は扱わない。
...
プロフィール構成の型: ①何の人か → ②ジャンルをスラッシュ区切り → ③読者メリット → ④PR表記。  
やらないこと: 美容・ファッション・ガジェット総合・なんでも売れ筋。  
