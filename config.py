...
# 日内枠（JST）。1日10投稿 = リアル苦悩7 + 商品紹介2 + 攻略1。
# 売り込みより共感つぶやきを厚くする（閲覧が伸びた実績ベース）。
...
# 静的な価値投稿（value_posts.py）。大半を苦悩枠にする。
VALUE_SLOTS: Tuple[int, ...] = (0, 1, 2, 3, 4, 5, 8, 9)

# 10投稿中7本は「30代共働きのリアル苦悩」共感つぶやき。
STRUGGLE_SLOTS: Tuple[int, ...] = (0, 1, 2, 3, 4, 8, 9)
